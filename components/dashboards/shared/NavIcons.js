...
export function IconUsers() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M16 11.5a2.5 2.5 0 1 1 0-5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
      <path d="M19 19c0-2.5-1.5-4.5-4-4.5" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconChart() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      ...
      <path d="M8 15v-4M12 15V9M16 15V6" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconStore() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M4 10 12 4l8 6v9H4v-9z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
...
export function IconReceipt() {
  return (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M7 4h10v16l-2-1.5L13 20l-2-1.5L9 20l-2-1.5L7 20V4z" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
...
export function IconLogout() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" aria-hidden>
      <path d="M10 7V5a2 2 0 0 1 2-2h7v16h-7a2 2 0 0 1-2-2v-2" stroke="currentColor" strokeWidth="1.8" strokeLinejoin="round" />
      <path d="M15 12H3m0 0 3-3M3 12l3 3" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
