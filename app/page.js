  ...
  return (
    <div className={styles.page}>
      ...
      <div className={styles.logoWrap}>
        <span className={styles.logoText}>Scratch</span><span className={styles.logoX}>X</span>
      </div>
      ...
      <div className={styles.hero}>
        ...
        <h1 className={styles.headline}>
          ...
          <span className={styles.headlineAccent}>in minutes</span>
        </h1>
        <p className={styles.subtitle}>
          Create campaigns, engage customers and
          turn walk-in customers into repeat buyers.
        </p>
      </div>
