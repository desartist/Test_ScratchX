...
export default function RetailersPage() {
  ...
  // Auto-refetch retailers when page becomes visible
  useEffect(() => {
    const handleVisibilityChange = async () => {
      if (document.visibilityState === "visible") {
        console.log("[Retailers] Page visible - refetching retailers");
        setPage(1);
      }
    };
      ...
      <div className={styles.page}>
        <div className={styles.container}>
          <div className={styles.header}>
            ...
            <Link href="/retailers/create" className={styles.primaryButton}>
              <Plus size={20} />
              Add Retailer
            </Link>
          </div>
              ...
              {retailers.length === 0 ? (
                <tr>
                  <td colSpan="8" className={styles.emptyState}>
                    ...
                    <Link href="/retailers/create" className={styles.createLink}>
                  ...
                  <tr key={retailer._id}>
                    ...
                    <td>
                      <div className={styles.actions}>
                        ...
                        <Link
                          href={`/retailers/${retailer._id}/assign`}
                          className={styles.actionBtn}
                          title="Assign Plan"
                        >
                          <Plus size={18} />
