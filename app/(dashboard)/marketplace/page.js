...
export default function MarketplacePage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/dashboard/distributor-overview/orders', {
        method: 'POST',
        credentials: 'include',
        headers: {
      ...
      const confirmRes = await fetch(`/api/dashboard/distributor-overview/orders/${json.data.orderId}`, {
        method: 'POST',
        credentials: 'include',
        headers: {
          'Content-Type': 'application/json',
        ...
        <div className={styles.container}>
          <div className={styles.confirmationCard}>
            ...
            <div className={styles.confirmationActions}>
              <Link href="/dashboard/distributor-overview" className={styles.primaryButton}>
                Back to Dashboard
              </Link>
              <Link href="/dashboard/retailers" className={styles.secondaryButton}>
                Assign Plans
              </Link>
            </div>
          </div>
