...
export const UNLIMITED_SCRATCHES_DURATION_DAYS = 365;
  ...
  async activateUnlimitedScratches(subscriptionId) {
    try {
      ...
      const validUntil = new Date(
        now.getTime() + UNLIMITED_SCRATCHES_DURATION_DAYS * 24 * 60 * 60 * 1000
      );
      ...
      const result = await Subscription.findByIdAndUpdate(
        subscriptionId,
        {
          $set: {
            ...
            "unlimitedScratches.scratchValidityType": "yearly",
            "unlimitedScratches.daysRemaining": UNLIMITED_SCRATCHES_DURATION_DAYS,
          },
        },
        { new: true }
      );
      ...
      return {
        success: true,
        validUntil,
        daysRemaining: UNLIMITED_SCRATCHES_DURATION_DAYS,
        message: `Unlimited scratches activated for ${UNLIMITED_SCRATCHES_DURATION_DAYS} days`,
      };
    } catch (error) {
