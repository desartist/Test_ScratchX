...
class PurchaseService {
   ...
   */
  async createDraftOrder(distributorId, items, userId, includeGst = true) {
    try {
      ...
      // Calculate pricing
      const pricing = commissionService.calculateBatchPricing(items, commissionPercentage, includeGst);
