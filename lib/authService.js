...
export const authService = {
  ...
  async resetPassword(token, newPassword) {
    // Callers already confirm the two password fields match client-side
    // before invoking this — the API just also requires confirmPassword
    // in the payload as a defense-in-depth check.
